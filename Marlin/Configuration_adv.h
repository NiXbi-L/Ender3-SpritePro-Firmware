...
//#define QUICK_HOME                        // Disabled: diagonal move assumes 0,0 origin, incompatible with our X_MIN=5 Y_MIN=5
 ...
 */
  ...
  #define SHOW_BOOTSCREEN                 // Show the Marlin bootscreen on startup. ** ENABLE FOR PRODUCTION **
    ...
    #define BOOTSCREEN_TIMEOUT 1000       // (ms) Total Duration to display the boot screen(s)  // Simulator
